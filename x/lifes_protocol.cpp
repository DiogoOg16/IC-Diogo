...
void _Lifes_Protocol::atualiza_Novolabel(double l, unsigned int t){
    if(l == 0)        lifes_sim.dados.curvas.actions.tipos = 0x00;
    else if (l == 1)  lifes_sim.dados.curvas.actions.tipos = 0x01;
    else if (l == 2)  lifes_sim.dados.curvas.actions.tipos = 0x02;
    else if (l == 3)  lifes_sim.dados.curvas.actions.tipos = 0x03;
    else if (l == 4)  lifes_sim.dados.curvas.actions.tipos = 0x04;
    else if (l == 5)  lifes_sim.dados.curvas.actions.tipos = 0x05;
    else if (l == 6)  lifes_sim.dados.curvas.actions.tipos = 0x06;
    else if (l == 7)  lifes_sim.dados.curvas.actions.tipos = 0x07;
    else if (l == 8)  lifes_sim.dados.curvas.actions.tipos = 0x08;
    else if (l == 9)  lifes_sim.dados.curvas.actions.tipos = 0x09;
    else if (l == 10)  lifes_sim.dados.curvas.actions.tipos = 0x0A;
    else if (l == 11)  lifes_sim.dados.curvas.actions.tipos = 0x0B;
    else if (l == 12)  lifes_sim.dados.curvas.actions.tipos = 0x0C;
   /* else if (l == 13)  lifes_sim.dados.curvas.actions.tipos = 0x0D;
    else if (l == 14)  lifes_sim.dados.curvas.actions.tipos = 0x0E;
    else if (l == 15)  lifes_sim.dados.curvas.actions.tipos = 0x0F;
    else if (l == 16)  lifes_sim.dados.curvas.actions.tipos = 0x10;
    else if (l == 17)  lifes_sim.dados.curvas.actions.tipos = 0x11;
    else if (l == 18)  lifes_sim.dados.curvas.actions.tipos = 0x12;
    else if (l == 19)  lifes_sim.dados.curvas.actions.tipos = 0x13;
    else if (l == 20)  lifes_sim.dados.curvas.actions.tipos = 0x14;
